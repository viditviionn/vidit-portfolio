...
export const PROJECTS = [
  {
    ...
    description:
      "CallupCalendar is an Baseball enthusiasts platform inspired by true joy from the national pastime -- experiencing games in person. Here user can catch the Top MLB Prospects Locally. The platform is built from scratch using MERN stack and hosted serverless in AWS. ",
  },
  {
    img: abbypagesProImg,
    title: "AbbyPages",
...

  {
    img: nokelsTv,
    title: "Nokels TV",
    pslink: "https://play.google.com/store/apps/details?id=com.nokelstv&pli=1/",
    description:
  ...
  },
  {
    img: slushDating,
    title: "Slush Dating",
    pslink: "https://www.slushdating.com/",
    description:
